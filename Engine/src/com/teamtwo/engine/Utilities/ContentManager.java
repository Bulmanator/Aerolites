...
public class ContentManager {
    ...
    public Texture loadTexture(String name, String filename) {
        ...
        try {
          ...
          //  t.loadFromFile(Paths.get(System.getProperty("user.dir") + File.separator + "Textures" + File.separator + filename));
            t.loadFromFile(Paths.get("C:\\Users\\janneht\\IdeaProjects\\Aerolites\\Game\\Content\\Fonts\\" + filename)); //DON'T FORGET TO CHANGE THIS EVERYTIME I MOVE COMPUTER TO SPECIFIED FOLDER
        }
    ...
    public Font loadFont(String name, String filename) {
        ...
        try {
            ...
            f.loadFromFile(Paths.get("C:\\Users\\janneht\\IdeaProjects\\Aerolites\\Game\\Content\\Fonts\\" + filename)); //DON'T FORGET TO CHANGE THIS EVERYTIME I MOVE COMPUTER TO SPECIFIED FOLDER
        }
        catch (IOException ex) {
            // If it fails the exit
